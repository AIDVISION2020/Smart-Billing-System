              ...
              <div className="flex flex-col items-center gap-y-2 w-full">
                <div className="w-full flex flex-col sm:flex-row items-center justify-between gap-4 mb-6">
                  ...
                  <input
                    ...
                    className="flex-grow w-full sm:w-auto px-4 py-2 text-sm rounded-xl border border-gray-700 bg-gray-900 text-white shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-200"
                  />
                  ...
                  <select
                    ...
                    className="sm:w-auto w-full px-4 py-2 text-sm rounded-xl border border-gray-700 bg-gray-900 text-white shadow-md focus:outline-none focus:ring-2 focus:ring-purple-500 transition-all duration-200 cursor-pointer"
                  >
                    <option value="updated">Sort by Last Updated</option>
                    <option value="created">Sort by Creation Date</option>
                    <option value="lexicographical">Sort by Name (A-Z)</option>
                  </select>
                </div>
